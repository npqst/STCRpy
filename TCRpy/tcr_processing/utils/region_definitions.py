...
# regions for TCR
_regions = {'imgt':{}}
_regions['imgt']['A'] = _regions['imgt']['B'] = '11111111111111111111111111222222222222333333333333333334444444444555555555555555555555555555555555555555666666666666677777777777'
...
_index_to_imgt_state =  {
    ...
    ('imgt', 'A'): {1: 0, 2: 1, 3: 2, 4: 3, 5: 4, 6: 5, 7: 6, 8: 7, 9: 8, 10: 9, 11: 10,
...
mhc_svec = '1111111111111116662222222222266333333336664444444444444445555555555555555555555555555555555555555555566666' # This is the state vector for mhc g-domains for regions
...
cd1_svec = '11111111111111166622222222222663333333366644444444444444455555555555555555555555555555555555555555555555' # This is the state vector for CD1 ga-like-domains for regions
...
_reg_tostring = {"1": "Astrand", "2": "Bstrand", "3": "Cstrand", "4": "Dstrand", "5": "Helix", "6": "Turn"} # http://www.imgt.org/IMGTScientificChart/Numbering/IMGTGsuperfamily.html
_reg_mhc_cdom = {"1": "Astrand", "2": "Bstrand", "3": "Cstrand", "4": "Dstrand", "5": "Estrand", "6": "Fstrand", "7": "Gstrand", "9": "Turn"} # C-Like domain
...
_index_to_imgt_state[("imgt", "MH1")] = {1: 0, 2: 1, 3: 2, 4: 3, 5: 4, 6: 5, 7: 6, 8: 8, 9: 9, 10: 10, 11: 11, 12: 12,
...
49: 49, 50: 57, 51: 58, 52: 59, 53: 60, 54: 61, 55: 65, 56: 66, 57: 67, 58: 68, 59: 69, 60: 70,
61: 71, 62: 74, 63: 75, 64: 76, 65: 77, 66: 78, 67: 79, 68: 80, 69: 81, 70: 82, 71: 83, 72: 84,
73: 86, 74: 87, 75: 88, 76: 89, 77: 90, 78: 91, 79: 92, 80: 93, 81: 94, 82: 95, 83: 96, 84: 97,
85: 98, 86: 99, 87: 100, 88: 101, 89: 102, 90: 103, 91: 104, 92: 105 }
_index_to_imgt_state[("imgt", "CD1")] = {1: 0, 2: 1, 3: 2, 4: 3, 5: 4, 6: 5, 7: 6, 8: 8, 9: 9, 10: 10, 11: 11, 12: 12, 13: 13, 14: 14,
 15: 15, 16: 16, 17: 17, 18: 18, 19: 19, 20: 20, 21: 21, 22: 22, 23: 23, 24: 24, 25: 25, 26: 26, 27: 27, 28: 28, 29: 29, 30: 30, 31: 31,
 32: 32, 33: 33, 34: 34, 35: 35, 36: 36, 37: 37, 38: 38, 39: 39, 40: 40, 41: 41, 42: 42, 43: 43, 44: 44, 45: 45, 46: 46, 47: 47, 48: 48,
 49: 49, 50: 57, 51: 58, 52: 59, 53: 60, 54: 61, 55: 63, 56: 64, 57: 65, 58: 66, 59: 67, 60: 68, 61: 69, 62: 72, 63: 73, 64: 74, 65: 75,
 66: 76, 67: 77, 68: 78, 69: 79, 70: 80, 71: 81, 72: 82, 73: 84, 74: 85, 75: 86, 76: 87, 77: 88, 78: 89, 79: 90, 80: 91, 81: 92, 82: 93,
 83: 94, 84: 95, 85: 96, 86: 97, 87: 98, 88: 99, 89: 100, 90: 101, 91: 102, 92: 103}

_index_to_imgt_state[("imgt", "GA1")] = _index_to_imgt_state[("imgt", "MH1")]
_index_to_imgt_state[("imgt", "GA2")] = dict([ (k+1000, v) for k,v in list(_index_to_imgt_state[("imgt", "GA1")].items()) ])
...
_index_to_imgt_state[("imgt", "MH1")].update( dict([ (k+1000, v) for k,v in list(_index_to_imgt_state[("imgt", "MH1")].items()) ]) )
...
_index_to_imgt_state[("imgt", "GA2L")] = dict([ (k+1000, v) for k,v in list(_index_to_imgt_state[("imgt", "CD1")].items()) ])
_index_to_imgt_state[("imgt", "CD1")].update( dict([ (k+1000, v) for k,v in list(_index_to_imgt_state[("imgt", "CD1")].items()) ]) )
...
class Accept(object):
    ...
    _macro_regions.update( { "framework": _macro_regions["bframework"] | _macro_regions["aframework"] | _macro_regions["dframework"] | _macro_regions["gframework"],
                             "cdrs": _macro_regions["bcdrs"] | _macro_regions["acdrs"] | _macro_regions["dcdrs"] | _macro_regions["gcdrs"],
    ...
    _macro_regions.update( { "ba": _macro_regions["vb"] | _macro_regions["va"],
                             "dg": _macro_regions["vd"] | _macro_regions["vg"],
                             "tr": _macro_regions["vb"] | _macro_regions["va"] | _macro_regions["vd"] | _macro_regions["vg"] }
                         )
    ...
    def accept(self, position, chain):
        if position in self.exclude[chain]:
            return 0
        elif get_region(position, chain) in self.regions or position in self.positions[chain]:
            return 1
        return 0
