...
N17.2/310569-N17-2_NRAS_rank_0/structures/it1/renumbered_complex_*.pdb"""
    ...
    def test_docking_angle_reverse_docks(self):
        parser = TCRParser.TCRParser()
        reverse_dock_108 = (
            "/home/quast/Projects/TCRpy/TCRpy/test/test_files/aligned_complex_108.pdb"
        )
        dock_63 = (
            "/home/quast/Projects/TCRpy/TCRpy/test/test_files/aligned_complex_63.pdb"
        )
    ...
    def test_MH1_TCRCoM(self):
        ...
        for tcr in tcr_structure.get_TCRs():
            ...
            print(r, theta, phi)
        pdb_file = (
            "TCRpy/TCRpy/tcr_geometry/reference_data/dock_reference_1_imgt_numbered.pdb"
        )
        tcr_structure = parser.get_tcr_structure("test", pdb_file)
        tcr_com = TCRCoM.MHCI_TCRCoM()
        for tcr in tcr_structure.get_TCRs():
    ...
    def test_MH2_TCRCoM(self):
        ...
        pdb_file = (
            "TCRpy/TCRpy/tcr_geometry/reference_data/dock_reference_2_imgt_numbered.pdb"
        )
        tcr_structure = parser.get_tcr_structure("test", pdb_file)
        tcr_com = TCRCoM.MHCII_TCRCoM()
        for tcr in tcr_structure.get_TCRs():
    ...
    def testTCRGeom(self):
        parser = TCRParser.TCRParser()
        pdb_files = glob.glob("TCRpy/test/test_files/TCRCoM_test_files/*.cif")
