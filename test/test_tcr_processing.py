...
class TestAnnotate(unittest.TestCase):
    ...
    def test_ga_not_identified(self):
        structure = self.pdb_parser.get_structure('', './test_files/4ms8.pdb')
        aligned_numbering, chain_type, germline_info, scTCR = annotate(structure[0]['A'])
        ...
        self.assertEqual(chain_type, 'GA2')
        self.assertEqual(germline_info, {'GA2': [('mouse', 'H2-L*01'), 0.8913043478260869]})
        self.assertFalse(scTCR)
